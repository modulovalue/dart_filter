...
abstract class CapitalizationFilter extends FilterCriteria<String> {
    ...
    const CapitalizationFilter(this.ignoreCapitalization) : assert(ignoreCapitalization != null);
...
class StartsWithFilter extends CapitalizationFilter {
    ...
    const StartsWithFilter(this.startsWith, bool ignoreCapitalization) : super(ignoreCapitalization);
...
class EndsWithFilter extends CapitalizationFilter {
    ...
    const EndsWithFilter(this.endsWith, bool ignoreCapitalization) : super(ignoreCapitalization);
...
class ContainsFilter extends CapitalizationFilter {
    ...
    const ContainsFilter(this.contains, bool ignoreCapitalization) : super(ignoreCapitalization);
